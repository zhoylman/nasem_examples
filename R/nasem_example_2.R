...
p2 = ggplot(slinky_data, aes(x = x, y = y, group = year, color = year)) +
  ...
  theme_bw() +
  labs(x = "JAS Potential Water Balance (mm)", y = "Probability Density (PDF)") +
